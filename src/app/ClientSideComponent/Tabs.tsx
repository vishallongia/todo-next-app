...
export const Tabs = ({
  ...
  return (
    <>
      <div
        className={cn(
          "flex justify-center items-center [perspective:1000px] relative overflow-auto sm:overflow-visible no-visible-scrollbar max-w-full bg-[#48aae6] p-[16px] rounded-xl",
          containerClassName
        )}
      >
